...
static list_item titles = {"Titres", COLOR_TEXT, titles_open};
static list_item pending_titles = {"Titres en attente", COLOR_TEXT, pendingtitles_open};
static list_item tickets = {"Tickets", COLOR_TEXT, tickets_open};
static list_item ext_save_data = {"Sauvegardes aditionnelles", COLOR_TEXT, extsavedata_open};
