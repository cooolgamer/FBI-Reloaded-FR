...
void action_import_secure_value(linked_list* items, list_item* selected) {
    prompt_display_yes_no("Confirmation", "Importer la secure value de ce titre?", COLOR_TEXT, selected->data, task_draw_title_info, action_import_secure_value_onresponse);
}